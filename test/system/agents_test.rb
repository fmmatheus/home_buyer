...
class AgentsTest < ApplicationSystemTestCase
  ...
  test "creating a Agent" do
    ...
    fill_in "Discount age", with: @agent.discount_age
    fill_in "Minimum incoming", with: @agent.minimum_incoming
    fill_in "Name", with: @agent.name
    fill_in "Neighborhood", with: @agent.neighborhood_id
    fill_in "Rate", with: @agent.rate
